"""
distilgpt2 en mode prompt (decoder-only)
Formule la tâche comme une continuation de texte. Greedy, déterministe.
"""
...
def main():
    ...
    emb_sims = compute_embedding_similarity(candidates, references, device)
